        ...
        <div class="row">
          <div class="col">
            ...
            >
              ...
              <path
                d="M832.24,474.63c0-.15,0-.3,0-.45l.11-.18C832.29,474.22,832.25,474.43,832.24,474.63Z"
                transform="translate(-44.49 -155.23)"
                opacity="0.1"
              />
              <path
          ...
          <div class="col">
            <div class="grid-container">
              ...
              <div class="b">
                <div class="small">
                  <DoughnutChart
                    :chartdata="staffsexdist"
                    :options="staffsexdistoptions"
                  ></DoughnutChart>
                </div>
              </div>
              <div class="c">
                <div class="small">
                  <DoughnutChart
                    :chartdata="staffenrollment"
                    :options="staffenrollmentoptions"
                  ></DoughnutChart>
                </div>
              </div>
            </div>
