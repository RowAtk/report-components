...
export default {
  ...
  mounted () {
    ...
    switch (lvl) {
      case 1: this.level = Level1 
      break;
      case 2: this.level = Level2
      break;
      case 3: this.level = Level3 
      break;
      case 4: this.level = Level4
      break;
      case 5: this.level = Level5 
      break;
      default: throw Error(`Level ${lvl} header does not exist`)
    }
  }
}
</script>
